 ...
 * sourcing/licensing a new texture asset.
 */

const HULL_LIT = '#20293e'
const HULL_SHADOW = '#04060c'
...
function drawScreenshotPanel(ctx: CanvasRenderingContext2D, cell: PanelCell, useMagenta: boolean) {
  ...
  // Fake UI content: a couple of thin "text" lines plus one accent block/"button".
...
export function generatePlanetTextures(isLowPower: boolean): PlanetTextureSet {
  ...
  cells.forEach((cell, i) => {
    ...
    const chance = withinCluster ? 0.55 : 0.03
