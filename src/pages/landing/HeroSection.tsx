import { FiCalendar, FiFileText, FiGithub, FiGlobe, FiLinkedin, FiMail, FiMapPin, FiPhone, FiUser } from 'react-icons/fi'
...
export function HeroSection() {
  ...
  return (
    <section id="hero" aria-labelledby="hero-heading" className="landing-hero">
      <motion.div
        {...entranceProps}
        style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)', maxWidth: 560, textAlign: 'left' }}
      >
        <p
          style={{
      ...
      >
        {about.photoUrl ? (
          <img src={about.photoUrl} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        ) : (
